   ...
   return(
      <>
          <Helmet>
                ...
                <meta name="description" content={`Eden Travels and Tours offers a wide range of services tailored to your travel needs. From flight bookings and accommodations to travel packages and corporate services, we provide exceptional travel experiences. Contact us today`} />
            </Helmet>   
