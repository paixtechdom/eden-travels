    ...
    return(
        <div className="w-full center flex-col gap-9 pb-[20vh]">
            <div className="flex flex-col items-center text-center gap-4">
                ...
                <p className="w-9/12">Lorem ipsum dolor sit amet, consectOur servicesetur adipisicing elit. Labore, voluptatem!</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-11/12 lg:w-10/12 gap-9">
                {
                    servicesList.map((service, i) => (
                        <div key={i} className="flex flex-col gap-6 text-sm w-full shadow-lg rounded-xl p-2 bg-gray-100">
                            ...
                            <div className="flex flex-col gap-3 p-3">
                                ...
                                <div className="flex flex-wrap lg:flex-row gap-3">
                                    {
                                        service.subservices.map((subservice, i) => (
                                            <p key={i} className="rounded-lg shadow-lg center bg-white p-2 text-gray-700 w-fit">
                                                {subservice.title}
                                            </p>
                                        ))
                                    }
                                ...
                                <Button text="Read more"
                                    className="bg-primary text-white font-semibold w-fit mt-4"
                                />
                            </div>
                        </div>
                    ))
